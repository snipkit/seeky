...
# stage_release.sh
# -----------------------------------------------------------------------------
# Stages an npm release for seeky.
#
...
cp -r bin/seeky.js "$TMPDIR/bin/seeky.js"
...
echo "Test Node:"
echo "    node ${TMPDIR}/bin/seeky.js --help"
if [[ "$INCLUDE_NATIVE" -eq 1 ]]; then
  echo "Test Rust:"
  echo "    SEEKY_RUST=1 node ${TMPDIR}/bin/seeky.js --help"
fi
