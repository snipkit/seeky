...
# run.sh — Create a new run_N directory for a Seeky task, optionally bootstrapped from a template,
# then launch Seeky with the task description from task.yaml.
#
# Usage:
