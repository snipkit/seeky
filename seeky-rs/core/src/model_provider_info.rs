//! Registry of model providers supported by Seeky.
//!
//! Providers can be defined in two places:
//!   1. Built-in defaults compiled into the binary so Seeky works out-of-the-box.
//!   2. User-defined entries inside `~/.seeky/config.toml` under the `model_providers`
    ...
    pub fn api_key(&self) -> crate::error::Result<Option<String>> {
        match &self.env_key {
            Some(env_key) => std::env::var(env_key)
                ...
                .map_err(|_| {
                    crate::error::SeekyErr::EnvVar(EnvVarError {
                        var: env_key.clone(),
