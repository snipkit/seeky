//! Functionality to persist a Seeky conversation *rollout* – a linear list of
...
///
/// ```ignore
/// $ jq -C . ~/.seeky/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// $ fx ~/.seeky/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// ```
#[derive(Clone)]
