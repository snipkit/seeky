...
describe("clearTerminal", () => {
  it("writes escape sequence to stdout", () => {
    const originalQuiet = process.env["SEEKY_QUIET_MODE"];
    delete process.env["SEEKY_QUIET_MODE"];

    process.env["SEEKY_QUIET_MODE"] = "0";
    ...
    if (originalQuiet !== undefined) {
      process.env["SEEKY_QUIET_MODE"] = originalQuiet;
    } else {
      delete process.env["SEEKY_QUIET_MODE"];
    }
  });
