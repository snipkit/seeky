...
// cover only the APIs that the Seeky codebase relies on. If full type
...
declare module "shell-quote" {
  ...
  // type definitions. We recreate the few that Seeky‑Lib imports so that the
   ...
   * plain string is sufficient for type‑checking the Seeky codebase while
   ...
   * redirection …) which we deliberately omit here because Seeky never
   * inspects them.
   */
