...
/**
 * Build a GitHub issues‐new URL that pre‑fills the Seeky 2‑bug‑report.yml
...
export function buildBugReportUrl({
  ...
  /** CLI revision string (e.g. output of `seeky --revision`) */
  cliVersion: string;
  /** Active model name */
  model: string;
  ...
  return `https://github.com/snipkit/seeky/issues/new?${params.toString()}`;
}
